...
class TestItem(BaseModel):
    ...
    mode: Annotated[
        Literal["EditMode", "PlayMode"], Field(description="The mode the test is for.")
    ]
...
@mcp_for_unity_resource(
    ...
    name="get_tests",
    description="Provides a list of all tests.",
)
...
@mcp_for_unity_resource(
    ...
    description="Provides a list of tests for a specific mode.",
)
async def get_tests_for_mode(
    ctx: Context,
    mode: Annotated[
        Literal["EditMode", "PlayMode"],
        Field(description="The mode to filter tests by."),
    ],
